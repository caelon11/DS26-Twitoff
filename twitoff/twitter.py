''' Handle connection to Twitter Datbase '''
...
def add_or_update_user(username):
    '''
    Takes a username and adds them to our database from the twitter DB
    ...
    try:
        ...
        for tweet in tweets:
            ...
            # Notes: If we added before appending we would likely get an error
